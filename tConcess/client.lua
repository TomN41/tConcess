...
function MenuConcess()
    local MConcess = RageUI.CreateMenu("Fantaisie", "Concessionnaire")
    local MConcessSub = RageUI.CreateSubMenu(MConcess, "Fantaisie", "Concessionnaire")
    local MConcessSub1 = RageUI.CreateSubMenu(MConcess, "Fantaisie", "Concessionnaire")
    local MConcessSub2 = RageUI.CreateSubMenu(MConcess, "Fantaisie", "Concessionnaire")
